...
export type QuoteRequestWithId = QuoteRequest & {
  id: string;
};
...
export type ContactMessageWithId = ContactMessage & {
  id: string;
};
...
export type OrderEvidenceWithId = OrderEvidence & {
  id: string;
};
...
export type InventoryActivityWithId = InventoryActivity & {
  id: string;
};
